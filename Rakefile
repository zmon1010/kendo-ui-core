...
task "internal_builds:upload" => [ "internal_builds:bundles:all", "internal_builds:uncheck_previous", "bundles:core", "bundles:appbuilder.core", "bower:push", "bower:push_core", "bower:push_appbuilder_core"  ]
