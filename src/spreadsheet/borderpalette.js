(function(f, define){
    ...
    (function(kendo) {
        ...
        var BORDER_PALETTE_MESSAGES = kendo.spreadsheet.messages.borderPalette = {
            ...
            bordersInside: "Inside borders",
            bordersInsideHorizontal: "Inside horizontal borders",
            bordersInsideVertical: "Inside vertical borders",
            bordersOutside: "Outside borders",
