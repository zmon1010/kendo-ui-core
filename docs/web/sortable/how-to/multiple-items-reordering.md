---
title: Reorder multiple items with Kendo Sortable
page_title: Reorder multiple items with Kendo Sortable
description: Reorder multiple items with Kendo Sortable
---

# Reorder Grid rows

The following runnable sample demonstrates how to reorder multiple items using Kendo UI Sortable
