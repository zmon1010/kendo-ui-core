...
description: An example on how to display a pop-up confirmation dialog for saving an uploaded file.
type: how to
page_title: Prompt Users before Uploading Files in Kendo UI Upload
