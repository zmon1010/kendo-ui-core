    ...
    internal static class SiteConstants
    {
        ...
        public readonly static string HelpStr =
            ...
            @"                           E.g. *.dll;*.exe or Dll\*.dll;Bin\*.exe or GAC:\mscorlib.dll or C:\MySearchDir\myfile.dll" + Environment.NewLine +
             ...
             "    ApiChange -whousesmethod \"Stopwatch(* Start())\" $net2dir\\System.dll -in $net2" + Environment.NewLine +
            ...
            @"    ApiChange -whoreferences gac:\system.configuration.dll -in C:\Windows\Microsoft.NET\Framework\v2.0.50727\*.dll" + Environment.NewLine +
             ...
             "    ApiChange -whousestype \"public enum System.IO.FileShare\" $net2dir\\mscorlib.dll -in $net2" + Environment.NewLine +
             ...
             "    ApiChange -whousesfield \"*(public !const * *)\" $net2dir\\mscorlib.dll -in $net2" + Environment.NewLine +
             ...
             "    ApiChange -whousesevent \"public *(public event * *)\" GAC:\\System.Windows.Forms.dll -in $net2" + Environment.NewLine +
             ...
             "    ApiChange -ws null -in $net2" + Environment.NewLine +
             "";
    }
}
