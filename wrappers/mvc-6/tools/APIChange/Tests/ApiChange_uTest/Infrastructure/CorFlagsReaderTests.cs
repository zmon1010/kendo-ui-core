...
namespace UnitTests.Infrastructure
{
    ...
    {
        private ProcessorArchitecture m_ProcessArchitecture = IntPtr.Size == 4 ? ProcessorArchitecture.X86 : ProcessorArchitecture.Amd64;
        ...
        public void Read_Unmanaged_Dll()
        {
            ...
            Assert.AreEqual(m_ProcessArchitecture, data.ProcessorArchitecture);
        }
