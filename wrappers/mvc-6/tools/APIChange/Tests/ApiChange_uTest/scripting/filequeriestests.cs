...
namespace UnitTests.Infrastructure
{
    ...
    public class FileQueriesTests
    {
        ...
        public void Can_Search_In_More_Than_One_Dir()
        {
            ...
            Assert.Greater(queries[0].Files.Length, 1);
        ...
        public void When_No_Directory_Is_Given_Use_Cwd()
        {
            ...
            try
            {
                ...
                var explorerExe = "explorer.exe";
                FileQuery query = new FileQuery(explorerExe);
                Assert.AreEqual(1, query.Files.Length);
                StringAssert.EndsWith(explorerExe, query.Files[0].ToLower());
            }
            finally
            {
