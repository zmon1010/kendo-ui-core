        ...
        public static AssemblyDefinition BaseLibV1Assembly
        {
            get
            {
                if( myBaseLibV1Assembly == null )
                    myBaseLibV1Assembly = AssemblyDefinition.ReadAssembly(BaseLibV1);
        ...
        public static AssemblyDefinition BaseLibV2Assembly
        {
            get
            {
                if( myBaseLibV2Assembly == null )
                    myBaseLibV2Assembly = AssemblyDefinition.ReadAssembly(BaseLibV2);
        ...
        public static AssemblyDefinition MscorlibAssembly
        {
            get
            {
                if( myMscorlibAssembly == null )
                    myMscorlibAssembly = AssemblyDefinition.ReadAssembly(typeof(IDisposable).Assembly.CodeBase.Substring(8).Replace('/', '\\'));
        ...
        public static AssemblyDefinition SystemCoreAssembly
        {
            get
            {
                if( mySystemCoreAssembly == null )
                    mySystemCoreAssembly = AssemblyDefinition.ReadAssembly(typeof(Func<int>).Assembly.CodeBase.Substring(8).Replace('/', '\\'));
        ...
        public static AssemblyDefinition DependandLibV1Assembly
        {
            get
            {
                if( myDependandLibV1Assembly == null )
                    myDependandLibV1Assembly = AssemblyDefinition.ReadAssembly(DependantLibV1);
        ...
        public static AssemblyDefinition DependandLibV2Assembly
        {
            get
            {
                if( myDependandLibV2Assembly == null )
                    myDependandLibV2Assembly = AssemblyDefinition.ReadAssembly(DependantLibV2);
