...
{
    /// <summary>
    /// Kendo UI MapLayerTooltipSettings class
    /// </summary>
    public partial class MapLayerTooltipSettings 
    {
        public bool? AutoHide { get; set; }

        public MapLayerTooltipAnimationSettings Animation { get; } = new MapLayerTooltipAnimationSettings();

        public MapLayerTooltipContentSettings Content { get; } = new MapLayerTooltipContentSettings();
