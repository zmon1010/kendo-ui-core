...
{
    /// <summary>
    /// Kendo UI MapMarkerDefaultsTooltipSettings class
    /// </summary>
    public partial class MapMarkerDefaultsTooltipSettings 
    {
        public bool? AutoHide { get; set; }

        public MapMarkerDefaultsTooltipAnimationSettings Animation { get; } = new MapMarkerDefaultsTooltipAnimationSettings();

        public MapMarkerDefaultsTooltipContentSettings Content { get; } = new MapMarkerDefaultsTooltipContentSettings();
        ...
        public MapMarkerDefaultsTooltipPosition? Position { get; set; }
