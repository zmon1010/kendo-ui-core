...
namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public partial class ChartValueAxisLabelsRotationSettingsBuilder
        
    {
        ...
        public ChartValueAxisLabelsRotationSettingsBuilder Align(string value)
        {
        ...
        public ChartValueAxisLabelsRotationSettingsBuilder Angle(double value)
        {
