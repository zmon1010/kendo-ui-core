...
namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public partial class ChartYAxisLabelsRotationSettingsBuilder
        
    {
        ...
        public ChartYAxisLabelsRotationSettingsBuilder Align(string value)
        {
        ...
        public ChartYAxisLabelsRotationSettingsBuilder Angle(double value)
        {
