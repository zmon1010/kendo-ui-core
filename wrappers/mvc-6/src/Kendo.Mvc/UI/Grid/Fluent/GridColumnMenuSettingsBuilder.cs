namespace Kendo.Mvc.UI.Fluent
{
    ...
    public class GridColumnMenuSettingsBuilder : IHideObjectMembers
    {
        ...
        /// </code>
        /// </example>
        public GridColumnMenuSettingsBuilder Messages(Action<GridColumnMenuMessagesBuilder> configurator)
        {
            configurator(new GridColumnMenuMessagesBuilder(settings.Messages));
