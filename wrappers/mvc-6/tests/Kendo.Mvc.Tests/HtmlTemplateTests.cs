namespace Kendo.Mvc.UI.Tests
{
    ...
    public class HtmlTemplateTests
    {
        ...
        public void Applying_when_html_is_set_sets_html_of_the_node()
        {
            ...
            node.Children.Each(child => child.WriteTo(sw, HtmlEncoder.Default));

            Assert.Equal(template.Html, sw.ToString());
        }
        ...
        public void Applying_when_inline_template_sets_html_of_the_node()
        {
            ...
            StringWriter sw = new StringWriter();
            node.WriteTo(sw, HtmlEncoder.Default);

            Assert.Equal("<div>foo</div>", sw.ToString());
        }
