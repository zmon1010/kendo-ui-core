namespace Kendo.Mvc.UI.Tests.RadialGauge
{
    ...
    public class RadialGaugeScaleBuilderTests
    {
        protected RadialGaugeScaleSettings scale;
        protected RadialGaugeScaleSettingsBuilder builder;

        public RadialGaugeScaleBuilderTests()
        {
            scale = new RadialGaugeScaleSettings();
            builder = new RadialGaugeScaleSettingsBuilder(scale);
        }
