namespace Kendo.Mvc.UI.Tests
{
    ...
    public class RadialGaugeScaleLabelsSerializationTests
    {
        private readonly RadialGaugeScaleLabelsSettings labels;

        public RadialGaugeScaleLabelsSerializationTests()
        {
            labels = new RadialGaugeScaleLabelsSettings();
        }
