namespace Kendo.Mvc.UI.Tests
{
    ...
    public class LinearGaugeTrackSerializationTests
    {
        private readonly LinearGaugePointerTrackSettings track;

        public LinearGaugeTrackSerializationTests()
        {
            track = new LinearGaugePointerTrackSettings();
        }
