namespace Kendo.Mvc.UI.Tests.LinearGauge
{
    ...
    public class LinearGaugeScaleBuilderTests
    {
        protected LinearGaugeScaleSettings scale;
        protected LinearGaugeScaleSettingsBuilder builder;

        public LinearGaugeScaleBuilderTests()
        {
            scale = new LinearGaugeScaleSettings();
            builder = new LinearGaugeScaleSettingsBuilder(scale);
        }
