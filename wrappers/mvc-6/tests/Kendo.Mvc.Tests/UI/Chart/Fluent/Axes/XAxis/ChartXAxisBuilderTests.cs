...
{
    public class ChartXAxisBuilderTests
    {
        private readonly ChartXAxis<SalesData> axis;
        private readonly ChartXAxisBuilder<SalesData> builder;

        public ChartXAxisBuilderTests()
        {
            axis = new ChartXAxis<SalesData>();
            builder = new ChartXAxisBuilder<SalesData>(axis);
        }
