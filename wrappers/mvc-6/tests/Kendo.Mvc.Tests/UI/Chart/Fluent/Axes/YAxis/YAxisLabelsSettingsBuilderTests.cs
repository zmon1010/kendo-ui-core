...
{
    public class YAxisLabelsSettingsBuilderTests
    {

        private readonly ChartYAxisLabelsSettings<SalesData> settings;
        private readonly ChartYAxisLabelsSettingsBuilder<SalesData> builder;

        public YAxisLabelsSettingsBuilderTests()
        {
            settings = new ChartYAxisLabelsSettings<SalesData>();
            builder = new ChartYAxisLabelsSettingsBuilder<SalesData>(settings);
        }
