...
{
    public class CategoryAxisLabelsSettingsBuilderTests
    {

        private readonly ChartCategoryAxisLabelsSettings<SalesData> settings;
        private readonly ChartCategoryAxisLabelsSettingsBuilder<SalesData> builder;

        public CategoryAxisLabelsSettingsBuilderTests()
        {
            settings = new ChartCategoryAxisLabelsSettings<SalesData>();
            builder = new ChartCategoryAxisLabelsSettingsBuilder<SalesData>(settings);
        }
        ...
        {
            builder.Rotation("value").ShouldBeSameAs(builder);
        }
    }
}
