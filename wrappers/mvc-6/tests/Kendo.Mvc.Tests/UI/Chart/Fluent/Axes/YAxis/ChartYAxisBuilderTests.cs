...
{
    public class ChartYAxisBuilderTests
    {
        private readonly ChartYAxis<SalesData> axis;
        private readonly ChartYAxisBuilder<SalesData> builder;

        public ChartYAxisBuilderTests()
        {
            axis = new ChartYAxis<SalesData>();
            builder = new ChartYAxisBuilder<SalesData>(axis);
        }
