...
{
    public class ValueAxisPlotBandBuilderTests
    {
        private readonly ChartValueAxisPlotBand<SalesData> plotBand;
        private readonly ChartValueAxisPlotBandBuilder<SalesData> builder;

        public ValueAxisPlotBandBuilderTests()
        {
            plotBand = new ChartValueAxisPlotBand<SalesData>();
            builder = new ChartValueAxisPlotBandBuilder<SalesData>(plotBand);
        }
