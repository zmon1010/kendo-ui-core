...
{
    public class XAxisLabelsSettingsBuilderTests
    {

        private readonly ChartXAxisLabelsSettings<SalesData> settings;
        private readonly ChartXAxisLabelsSettingsBuilder<SalesData> builder;

        public XAxisLabelsSettingsBuilderTests()
        {
            settings = new ChartXAxisLabelsSettings<SalesData>();
            builder = new ChartXAxisLabelsSettingsBuilder<SalesData>(settings);
        }
