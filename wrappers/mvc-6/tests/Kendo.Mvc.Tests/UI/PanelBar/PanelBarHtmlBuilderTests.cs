namespace Kendo.Mvc.UI.Html.Tests
{
    ...
    public class PanelBarHtmlBuilderTests
    {
        ...
        public PanelBarHtmlBuilderTests()
        {
            ...
            urlGenerator.Setup(s => s.Generate(It.IsAny<ActionContext>(), It.IsAny<INavigatable>()))
                        .Returns("http://www.google.com/");

            panelBar = new PanelBar(TestHelper.CreateViewContext(urlGenerator));
            panelBar.Name = "PanelBar1";

            item = new PanelBarItem();

            renderer = new PanelBarHtmlBuilder(panelBar);
        }
        ...
        public void Should_render_selected_class_if_item_is_selected()
        {
            ...
            Assert.Contains("k-link k-state-selected", tag.Attribute("class"));
        }
        ...
        public void Should_output_sprite()
        {
            ...
            StringWriter sw = new StringWriter();
            tag.Children[1].WriteTo(sw, HtmlEncoder.Default);
