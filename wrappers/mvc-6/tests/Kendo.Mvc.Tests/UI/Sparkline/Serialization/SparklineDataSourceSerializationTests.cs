...
{
    public class SparklineDataSourceSerializationTests
    {
        private readonly Sparkline<SalesData> chart;

        public SparklineDataSourceSerializationTests()
        {
            chart = SparklineTestHelper.CreateSparkline<SalesData>();
        }
