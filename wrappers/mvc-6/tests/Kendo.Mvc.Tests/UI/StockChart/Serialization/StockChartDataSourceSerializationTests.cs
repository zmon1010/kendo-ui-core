...
{
    public class StockChartDataSourceSerializationTests
    {
        private readonly StockChart<SalesData> chart;

        public StockChartDataSourceSerializationTests()
        {
            chart = StockChartTestHelper.CreateStockChart<SalesData>();
        }
