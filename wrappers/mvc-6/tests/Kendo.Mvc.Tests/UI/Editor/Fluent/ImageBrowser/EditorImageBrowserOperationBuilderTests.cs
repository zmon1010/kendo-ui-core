...
{
    public class EditorImageBrowserOperationBuilderTests
    {
        private readonly EditorImageBrowserOperation operation;
        private readonly Editor editor;
        private readonly EditorImageBrowserOperationBuilder builder;
        ...
        public EditorImageBrowserOperationBuilderTests()
        {
            operation = new EditorImageBrowserOperation();
            editor = new Editor(TestHelper.CreateViewContext());
            builder = new EditorImageBrowserOperationBuilder(operation, editor.ViewContext, editor.UrlGenerator);
