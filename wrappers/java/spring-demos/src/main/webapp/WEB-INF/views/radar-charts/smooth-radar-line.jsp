...
<demo:header />
    <div class="demo-section k-content wide">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="radarLine" style="smooth" field="budget" name="Budget" />
                <kendo:chart-seriesItem type="radarLine" style="smooth" field="spending" name="Spending" />
             </kendo:chart-series>
