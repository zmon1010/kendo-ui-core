...
<demo:header />
    ...
    <!-- responsive panel, collapsed on small screens -->
     <kendo:responsivePanel name="sidebar">
        ...
        <div id="teammates" class="widget">
            ...
            <div>
                <div class="team-mate">
                    <img src="<c:url value="/resources/web/panelbar/andrew.jpg" />" alt="Andrew Fuller">
                    <h4>Andrew Fuller</h4>
                    <p>Team Lead</p>
                </div>
                <div class="team-mate">
                    <img src="<c:url value="/resources/web/panelbar/nancy.jpg" />" alt="Nancy Leverling">
                    <h4>Nancy Leverling</h4>
                    <p>Sales Associate</p>
                </div>
                <div class="team-mate">
                    <img src="<c:url value="/resources/web/panelbar/robert.jpg" />" alt="Robert King">
                    <h4>Robert King</h4>
...
<style>
    ...
    .profile-photo {
        ...
        border-radius: 100px;
        border: 1px solid #e7e7e7;
        background: url(<c:url value="/resources/web/Customers/ISLAT.jpg" />) no-repeat 50% 50%;
    }
