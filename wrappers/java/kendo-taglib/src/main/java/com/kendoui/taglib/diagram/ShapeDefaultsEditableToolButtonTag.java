...
public class ShapeDefaultsEditableToolButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ShapeDefaultsEditableToolButtonsTag parent = (ShapeDefaultsEditableToolButtonsTag)findParentWithClass(ShapeDefaultsEditableToolButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-shapeDefaults-editable-tool-button";
    }

    public void setClick(ShapeDefaultsEditableToolButtonClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setToggle(ShapeDefaultsEditableToolButtonToggleFunctionTag value) {
