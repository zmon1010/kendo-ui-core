...
public class SheetRowCellBorderBottomTag extends  BaseTag  /* interfaces */ /* interfaces */ {
...
//>> Attributes
    ...
    public static String tagName() {
        return "spreadsheet-sheet-row-cell-borderBottom";
    }
