...
public class EditableToolButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        EditableToolButtonsTag parent = (EditableToolButtonsTag)findParentWithClass(EditableToolButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-editable-tool-button";
    }

    public void setClick(EditableToolButtonClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setToggle(EditableToolButtonToggleFunctionTag value) {
