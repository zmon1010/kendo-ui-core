...
//>> Attributes
    ...
    public void setButtons(ShapeDefaultsEditableToolButtonsTag value) {

        setProperty("buttons", value.buttons());

    }

    public void setMenuButtons(ShapeDefaultsEditableToolMenuButtonsTag value) {

        setProperty("menuButtons", value.menuButtons());

    }

    public void setClick(ShapeDefaultsEditableToolClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setOverflowTemplate(ShapeDefaultsEditableToolOverflowTemplateFunctionTag value) {
        setEvent("overflowTemplate", value.getBody());
    }

    public void setTemplate(ShapeDefaultsEditableToolTemplateFunctionTag value) {
        setEvent("template", value.getBody());
    }

    public void setToggle(ShapeDefaultsEditableToolToggleFunctionTag value) {
