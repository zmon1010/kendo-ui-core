...
public class ConnectionDefaultsEditableToolMenuButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ConnectionDefaultsEditableToolMenuButtonsTag parent = (ConnectionDefaultsEditableToolMenuButtonsTag)findParentWithClass(ConnectionDefaultsEditableToolMenuButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-connectionDefaults-editable-tool-menuButton";
    }
