...
public class ShapeEditableToolButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ShapeEditableToolButtonsTag parent = (ShapeEditableToolButtonsTag)findParentWithClass(ShapeEditableToolButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-shape-editable-tool-button";
    }

    public void setClick(ShapeEditableToolButtonClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setToggle(ShapeEditableToolButtonToggleFunctionTag value) {
