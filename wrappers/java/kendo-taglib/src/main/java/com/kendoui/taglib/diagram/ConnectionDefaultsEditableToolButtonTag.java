...
public class ConnectionDefaultsEditableToolButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ConnectionDefaultsEditableToolButtonsTag parent = (ConnectionDefaultsEditableToolButtonsTag)findParentWithClass(ConnectionDefaultsEditableToolButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-connectionDefaults-editable-tool-button";
    }

    public void setClick(ConnectionDefaultsEditableToolButtonClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setToggle(ConnectionDefaultsEditableToolButtonToggleFunctionTag value) {
