...
public class EditableToolMenuButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        EditableToolMenuButtonsTag parent = (EditableToolMenuButtonsTag)findParentWithClass(EditableToolMenuButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-editable-tool-menuButton";
    }
