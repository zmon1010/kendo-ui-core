...
public class ShapeDefaultsEditableToolMenuButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ShapeDefaultsEditableToolMenuButtonsTag parent = (ShapeDefaultsEditableToolMenuButtonsTag)findParentWithClass(ShapeDefaultsEditableToolMenuButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-shapeDefaults-editable-tool-menuButton";
    }
