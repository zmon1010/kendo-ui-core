...
//>> Attributes
    ...
    public void setButtons(ShapeEditableToolButtonsTag value) {

        setProperty("buttons", value.buttons());

    }

    public void setMenuButtons(ShapeEditableToolMenuButtonsTag value) {

        setProperty("menuButtons", value.menuButtons());

    }

    public void setClick(ShapeEditableToolClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setOverflowTemplate(ShapeEditableToolOverflowTemplateFunctionTag value) {
        setEvent("overflowTemplate", value.getBody());
    }

    public void setTemplate(ShapeEditableToolTemplateFunctionTag value) {
        setEvent("template", value.getBody());
    }

    public void setToggle(ShapeEditableToolToggleFunctionTag value) {
