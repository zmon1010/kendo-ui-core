...
//>> Attributes
    ...
    public void setButtons(ConnectionDefaultsEditableToolButtonsTag value) {

        setProperty("buttons", value.buttons());

    }

    public void setMenuButtons(ConnectionDefaultsEditableToolMenuButtonsTag value) {

        setProperty("menuButtons", value.menuButtons());

    }

    public void setClick(ConnectionDefaultsEditableToolClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setOverflowTemplate(ConnectionDefaultsEditableToolOverflowTemplateFunctionTag value) {
        setEvent("overflowTemplate", value.getBody());
    }

    public void setTemplate(ConnectionDefaultsEditableToolTemplateFunctionTag value) {
        setEvent("template", value.getBody());
    }

    public void setToggle(ConnectionDefaultsEditableToolToggleFunctionTag value) {
