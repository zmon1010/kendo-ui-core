...
//>> Attributes
    ...
    public void setButtons(ConnectionEditableToolButtonsTag value) {

        setProperty("buttons", value.buttons());

    }

    public void setMenuButtons(ConnectionEditableToolMenuButtonsTag value) {

        setProperty("menuButtons", value.menuButtons());

    }

    public void setClick(ConnectionEditableToolClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setOverflowTemplate(ConnectionEditableToolOverflowTemplateFunctionTag value) {
        setEvent("overflowTemplate", value.getBody());
    }

    public void setTemplate(ConnectionEditableToolTemplateFunctionTag value) {
        setEvent("template", value.getBody());
    }

    public void setToggle(ConnectionEditableToolToggleFunctionTag value) {
