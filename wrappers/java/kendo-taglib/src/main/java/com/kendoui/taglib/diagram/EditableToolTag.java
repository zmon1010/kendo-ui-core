...
//>> Attributes
    ...
    public void setButtons(EditableToolButtonsTag value) {

        setProperty("buttons", value.buttons());

    }

    public void setMenuButtons(EditableToolMenuButtonsTag value) {

        setProperty("menuButtons", value.menuButtons());

    }

    public void setClick(EditableToolClickFunctionTag value) {
        setEvent("click", value.getBody());
    }

    public void setOverflowTemplate(EditableToolOverflowTemplateFunctionTag value) {
        setEvent("overflowTemplate", value.getBody());
    }

    public void setTemplate(EditableToolTemplateFunctionTag value) {
        setEvent("template", value.getBody());
    }

    public void setToggle(EditableToolToggleFunctionTag value) {
