...
public class ShapeEditableToolMenuButtonTag extends  BaseTag  /* interfaces */ /* interfaces */ {
    
    @Override
    public int doEndTag() throws JspException {
//>> doEndTag

        ShapeEditableToolMenuButtonsTag parent = (ShapeEditableToolMenuButtonsTag)findParentWithClass(ShapeEditableToolMenuButtonsTag.class);
...
//>> Attributes
    ...
    public static String tagName() {
        return "diagram-shape-editable-tool-menuButton";
    }
