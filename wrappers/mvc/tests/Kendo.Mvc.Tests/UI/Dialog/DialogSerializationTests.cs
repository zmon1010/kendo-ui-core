namespace Kendo.Mvc.UI.Tests
{
    ...
    public class DialogSerializationTests
    {
        ...
        public DialogSerializationTests()
        {
            ...
            dialog = DialogTestHelper.CreateDialog();
            dialog.Name = "dialog";
            //builder = new DialogBuilder(dialog);
        }

        [Fact]
        public void Default_configuration_outputs_empty_Dialog_init()
        {
        ...
        {
            dialog.Animation = new PopupAnimation() { Enabled = false };
            dialog.WriteInitializationScript(textWriter.Object);
