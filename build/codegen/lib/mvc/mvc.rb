...
module CodeGen::MVC::Wrappers
    ...
    IGNORED = [
        ...
        'editor.messages.bold',
        'editor.messages.italic',
        'editor.messages.underline',
        'editor.messages.strikethrough',
        'editor.messages.superscript',
        'editor.messages.subscript',
        'editor.messages.justifycenter',
        'editor.messages.justifyleft',
        'editor.messages.justifyright',
        'editor.messages.justifyfull',
        'editor.messages.insertorderedlist',
        'editor.messages.insertunorderedlist',
        'editor.messages.indent',
        'editor.messages.outdent',
        'editor.messages.createlink',
        'editor.messages.unlink',
        'editor.messages.insertimage',
        'editor.messages.insertfile',
        'editor.messages.inserthtml',
        'editor.messages.fontname',
        'editor.messages.fontnameinherit',
        'editor.messages.fontsize',
        'editor.messages.fontsizeinherit',
        'editor.messages.formatblock',
        'editor.messages.formatting',
        'editor.messages.cleanformatting',
        'editor.messages.print',
        'editor.messages.styles',
        'editor.messages.forecolor',
        'editor.messages.backcolor',
        'editor.messages.viewhtml',
        'editor.messages.imagewebaddress',
        'editor.messages.imagealttext',
        'editor.messages.linkwebaddress',
        'editor.messages.linktext',
        'editor.messages.linktooltip',
        'editor.messages.linkopeninnewwindow',
        'editor.messages.dialoginsert',
        'editor.messages.dialogbuttonseparator',
        'editor.messages.dialogcancel',
        'editor.messages.dialogupdate',
        'editor.messages.createtable',
        'editor.messages.addcolumnleft',
        'editor.messages.addcolumnright',
        'editor.messages.addrowabove',
        'editor.messages.addrowbelow',
        'editor.messages.deleterow',
        'editor.messages.deletecolumn', 
        'editor.messages.deletefile',
        'editor.messages.directorynotfound',
        'editor.messages.emptyfolder',
        'editor.messages.invalidfiletype',
        'editor.messages.orderby',
        'editor.messages.orderbyname',
        'editor.messages.orderbysize',
        'editor.messages.overwritefile',
        'editor.messages.uploadfile',
        'editor.messages.dropfileshere',
        'editor.messages.search',
        'colorpicker.palette',
