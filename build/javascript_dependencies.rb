    ...
    categories = [
        {
            ...
            'description' => 'Below are listed the script files for Kendo UI desktop widgets for mobile-ready websites and applications:',
        ...
        },
        {
            ...
            'description' => 'Below are listed the script files for Kendo UI Barcodes:',
        ...
        },
        {
            ...
            'description' => 'Below are listed the script files for Kendo UI supplementary scripts for integration with server-side technologies:',
            'include' => /^aspnetmvc/i
        },
        {
            ...
            'description' => 'Below are listed the script files for the Kendo UI Diagrams and Maps:',
            'include' => /^dataviz\.(diagram|map)$/i
        },
        {
            'name' => 'Scheduling widgets',
