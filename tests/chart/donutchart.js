(function() {
    ...
    (function() {
        ...
        (function() {
            ...
            // ------------------------------------------------------------
            module("Donut Segment / custom visual");
            ...
            test("passes radius, innerRadius, startAngle, endAngle and center to custom visual function", function() {
                createSegment({
                    visual: function(e) {
                       var startAngle = (segment.sector.startAngle + 180) % 360;
                       equal(e.radius, segment.sector.r);
                       equal(e.innerRadius, segment.sector.ir);
