(function() {
                ...
                '<ul class="k-group">' +
                    '<li class="k-item k-first k-last">' +
                        '<div class="k-top k-bot">' +
                            '<span class="k-icon k-i-arrow-45-down-right"></span>' +
    ...
    test("toggle buttons are rendered correctly when initializing from html", function() {
        ...
        equal(dom.find(".k-icon.k-i-arrow-60-right").length, 1);
        equal(dom.find(".k-icon.k-i-arrow-45-down-right").length, 1);
    });
