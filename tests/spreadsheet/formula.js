(function(){
    ...
    test("RC-style notation", function(){
        ...
        var exp = calc.parse(Sheet1, 0, 0, "=R[]C2");
        equal(exp.ast.print(0, 0), "$B1");
        var exp = calc.parse(Sheet1, 0, 0, "=R2C[]");
        equal(exp.ast.print(0, 0), "A$2");
        var exp = calc.parse(Sheet1, 0, 0, "=R[-2]C[-2]");
        equal(exp.ast.print(2, 2), "A1");
        var exp = calc.parse(Sheet1, 0, 0, "=RC1:RE1");
        equal(exp.ast.print(0, 0), "RC1:RE1");
    });
    ...
    test("BETA.DIST", function(){
        calcTest({
            ...
            "=BETADIST(0.60709662860678, 1.6, 1)": 0.449999999999992,
    ...
    test("T/DIST", function(){
        calcTest({
            ...
            "=T.DIST(1.3, 19, true)": 0.895424249851375,
            ...
            "=T.TEST({11.4, 17.3, 21.3, 25.9, 40.1}, {23.2, 25.8, 29.9, 33.5, 42.7}, 1, 2)": 0.1118043223496,
        });
    });
