(function() {
    ...
    test("opening error dialog without text loads default text for type", 1, function() {
        ...
        equal($(document.activeElement).closest(".k-spreadsheet-message").text(), "The value that you entered violates the validation rules set on the cell.RetryCancel");
    });
    ...
    test("opening error dialog with text loads it instead of default message for type", 1, function() {
        ...
        equal($(document.activeElement).closest(".k-spreadsheet-message").text(), "Custom message.RetryCancel");
    });

    test("validation error dialog buttons", function() {
